            ...
            <GlassCard className="p-8 neon-glow gradient-border" tilt={false}>
              ...
              <div className="space-y-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full gradient-bg text-primary-foreground font-semibold py-3 rounded-xl neon-glow-strong"
                >
                ...
                <button className="w-full glass rounded-xl py-3 text-foreground font-medium hover:bg-muted/20 transition-all flex items-center justify-center gap-2">
